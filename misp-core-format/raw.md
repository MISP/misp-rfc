...
Other
:   comment, text, other, size-in-bytes, counter, integer, datetime, cpe, port, float, hex, phone-number, boolean, anonymised, pgp-public-key, pgp-private-key, uuid
...
~~~~
{
  ...
  "id": "https://github.com/MISP/MISP/blob/2.5/format/2.5/schema.json",
  "defs": {
    "org": {
      "type": "object",
